  ...
  const handleBarCodeScanned = ({ type, data }) => {
    ...
    if (
      ...
      setScanned(false);
          ...
          Alert.alert("This doesn't appear to be an Interclip URL","Do you still want to open it?",
       [
    {
      text: 'Cancel',
      onPress: () => {setScanned(true); sleep(1000).then(setScanned(false))},
      style: 'cancel'
    },
    { text: 'Sure', onPress: () =>  {Linking.openURL(data); setScanned(false);}
 }
      ])
    }
  };
